...
namespace LionRacingGame
{
    public partial class RacingForm : Form
    {
        ...
        private void SetupRaceTrack()
        {
            ...
            punters[0] = pFactory.getPunter("Jo", MaximumBet, JoBet); //getting Jo object from factory class
            punters[1] = pFactory.getPunter("Mary", MaximumBet, MaryBet); //getting Mary object from factory class
            punters[2] = pFactory.getPunter("Ali", MaximumBet, AliBet); //getting Ali object from factory class
        ...
        private void JoButton_CheckedChanged(object sender, EventArgs e)
        {
            setMaximumBetTextLabel(punters[0].Cash);
        }

        private void MaryButton_CheckedChanged(object sender, EventArgs e)
        {
            setMaximumBetTextLabel(punters[1].Cash);
        }

        private void AliButton_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void Bets_Click(object sender, EventArgs e)
        {
            ...
            if (MaryRButton.Checked)
            {
                PunterNum = 1;
            }
            if (AliRButton.Checked)
            {
                PunterNum = 2;
            }
